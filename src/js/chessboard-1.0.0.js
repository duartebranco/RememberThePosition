...
(function () {
    ...
    function validSemanticVersion(version, minimum) {
        ...
        var versionNum =
            version.major * 100000 * 100000 +
            version.minor * 100000 +
            version.patch;
        var minimumNum =
            minimum.major * 100000 * 100000 +
    ...
    if (RUN_ASSERTS) {
        ...
        console.assert(
            interpolateTemplate("{a}bc{a}bc", { a: "x" }) === "xbcxbc",
        );
        console.assert(
    ...
    if (RUN_ASSERTS) {
        ...
        console.assert(
            objToFen({ a2: "wP", b2: "bP" }) === "8/8/8/8/8/8/Pp6/8",
        );
    }
    ...
    function expandConfig(config) {
        ...
        if (
            ...
            config.pieceTheme = "src/img/chesspieces/wikipedia/{piece}.png";
        }
    ...
    function constructor(containerElOrString, config) {
        ...
        function drawPositionInstant() {
            ...
            for (var i in currentPosition) {
                ...
                $("#" + squareElsIds[i]).append(
                    buildPieceHTML(currentPosition[i]),
                );
            }
        }
        ...
        function updateDraggedPiece(x, y) {
            ...
            if (validSquare(draggedPieceLocation)) {
                $("#" + squareElsIds[draggedPieceLocation]).removeClass(
                    CSS.highlight2,
                );
            }
        ...
        function stopDraggedPiece(location) {
            ...
            if (isFunction(config.onDrop)) {
                ...
                if (
                    validSquare(draggedPieceSource) &&
                    location === "offboard"
                ) {
        ...
        var throttledMousemoveWindow = throttle(
            mousemoveWindow,
        ...
        var throttledTouchmoveWindow = throttle(
            touchmoveWindow,
            config.dragThrottleRate,
        );
        ...
        function initDOM() {
            ...
            if (config.sparePieces) {
                ...
                $sparePiecesBottom = $container.find(
